...
idx_p = knnsearch( protected, protected(class_p == 2, :),'K', 8 );
idx_u = knnsearch( unprotected, protected(class_p == 2, :),'K', 8 );
...
%k=32
idx_p = knnsearch( protected, protected(class_p == 2, :),'K', 32 );
idx_u = knnsearch( unprotected, protected(class_p == 2, :),'K', 32 );
n = size(idx_p, 1);
p1 = zeros(1,n);
for i=1:n
    tbl = tabulate(class_p(idx_p(i,:)));
